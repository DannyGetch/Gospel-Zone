...
A spotifiy like app for gospel songs only.
...
1. Clone the repo
   ...
   ```shell
    git clone https://github.com/DannyGetch/Gospel-Zone.git
   ```
...
4. Go to [Pull Requests](https://github.com/DannyGetch/Gospel-Zone/pulls) and click on the `New Pull Request` button.
